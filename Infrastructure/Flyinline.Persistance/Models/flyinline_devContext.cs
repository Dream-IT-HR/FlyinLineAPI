...
{
    public partial class flyinline_devContext : DbContext
    {
        public flyinline_devContext()
        {
        }

        public flyinline_devContext(DbContextOptions<flyinline_devContext> options)
            : base(options)
        {
        }
